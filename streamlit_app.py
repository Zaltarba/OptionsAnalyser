...
min_strike = st.slider('Select minimum strike price', 0, value=min_strike, step=step)
max_strike = st.slider('Select maximum strike price', 0, 3000, value=max_strike, step=step)
